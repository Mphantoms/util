package com.soofound.common.vo;
...
public class ExcelUtil{
     ...
     * @param out 输出流
     */
    public static void exportExcelSudsidy(String title,Map<String, String> headMap,JSONArray jsonArray,String datePattern,int colWidth, OutputStream out) {
        if(datePattern==null) datePattern = DEFAULT_DATE_PATTERN;
        // 声明一个工作薄
        SXSSFWorkbook workbook = new SXSSFWorkbook(1000);//缓存
        workbook.setCompressTempFiles(true);
    ...
    public static void downloadExcelFile(String title,Map<String,String> headMap,JSONArray ja,HttpServletResponse response){
        try {
            ...
            ExcelUtil.exportExcelX(title,headMap,ja,null,0,out);
